...
return [
    ...
    */
    ...
    'logo' => '<b>Analitca Woman+D</b>',
    'logo_img' => 'assets/assets/img_aw/logo.png',
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => false,
        'img' => [
            'path' => 'assets/assets/img_aw/logo.png',
            'alt' => 'AW Logo',
            'class' => '',
            'width' => 50,
            'height' => 50,
...
=======
        ...
        [
            ...
            'url' => url('responsabilidadSocial'),
            'icon' => 'fas fa-fw fa-hand-holding-heart',
        ],
        [
            'text' => 'Bolsa de empleos',
            'url' => url('bolsaEmpleos'),
            'icon' => 'fas fa-fw fa-briefcase',
        ],
        [
            'text' => 'Equipo de liderazgo',
            'url' => url('equipoLiderazgo'),
            'icon' => 'fas fa-fw fa-users',
        ],
        [
            'text' => 'Eventos',
