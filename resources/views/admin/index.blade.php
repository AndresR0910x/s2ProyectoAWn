  ...
  <div class="row">
    ...
    <div class="col-md-6 col-lg-4">
      <div class="card text-white bg-primary mb-3" style="max-width: 18rem;">
        ...
        <div class="card-body">
          <h5 class="card-title">Total:<?= $dataEvento ?></h5>
        </div>
      </div>
    </div>
    <div class="col-md col-lg-4" id="containerFive">
      <div class="card text-white bg-secondary mb-3" style="max-width: 18rem;">
        <div class="card-header">Cursos</div>
        <div class="card-body">
          <h5 class="card-title">Total:<?= $dataHorariosCursos ?></h5>
        </div>
      </div>
    </div>
    <div class="col-md-6 col-lg-4" id="containerSix">
      <div class="card text-white bg-danger mb-3 " style="max-width: 18rem;">
        ...
        <div class="card-body">
          <h5 class="card-title">Total:<?= $dataHoraiosEmpleos ?></h5>
        </div>
      </div>
    </div>
    <div class="col-md-6 col-lg-4" id="containerSeven">
      <div class="card text-white bg-success mb-3" style="max-width: 18rem;">
        <div class="card-header">Responsabilidades sociales</div>
        <div class="card-body">
          <h5 class="card-title">Total:<?= $dataResponsabilidadSocial ?></h5>
        </div>
      </div>
    </div>
    <div class="col-md-6 col-lg-4" id="containerEight">
      <div class="card text-white bg-warning mb-3" style="max-width: 18rem;">
        ...
        <div class="card-body">
          <h5 class="card-title">Total:<?= $dataServicio ?></h5>
        </div>
      </div>
    </div>
  </div>
